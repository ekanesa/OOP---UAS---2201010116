...
import static belipenjor.loadIMG.loadImage;
 ...
 */
public class jForm22 extends javax.swing.JFrame {
    DefaultTableModel TM = new DefaultTableModel();

    /**
     * Creates new form jForm22
     */
    public jForm22() throws SQLException{
...
private void StoreData() throws SQLException {
    ...
    private void btnBARUActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBARUActionPerformed
        if(btnBARU.getText().equals("Baru")){
            ...
            try {
                ...
                Logger.getLogger(jForm22.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void btnHAPUSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHAPUSActionPerformed
        ...
        if (jwb == JOptionPane.YES_OPTION) {
            try {
                ...
                Logger.getLogger(jForm22.class.getName()).log(Level.WARNING, "Invalid ID format", ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jForm22.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
